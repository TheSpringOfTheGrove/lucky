package com.hnz.luck5.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.hnz.luck5.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
