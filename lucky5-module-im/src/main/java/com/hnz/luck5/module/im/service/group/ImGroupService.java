...
public interface ImGroupService {
     ...
     * @throws com.hnz.luck5.framework.common.exception.ServiceException 群已满抛 GROUP_MEMBER_EXCEED
     */
     ...
     * 获取指定用户的群列表
     * <p>
     * 返回用户当前仍有效的群，以及最近 lucky5.im.message.group-pull-max-days 天内退群的群
     ...
     * 置顶群消息（仅群主或管理员可执行）
     * <p>
     * 上限由 lucky5.im.group.pin-max-count 控制；幂等失败时抛业务异常
     *
     * @param userId    当前登录用户编号
     * @param groupId   群编号
