package com.hnz.luck5.framework.security.config;
...
import com.hnz.luck5.framework.security.core.context.TransmittableThreadLocalSecurityContextHolderStrategy;
import com.hnz.luck5.framework.security.core.filter.TokenAuthenticationFilter;
import com.hnz.luck5.framework.security.core.handler.AccessDeniedHandlerImpl;
import com.hnz.luck5.framework.security.core.handler.AuthenticationEntryPointImpl;
import com.hnz.luck5.framework.security.core.service.SecurityFrameworkService;
import com.hnz.luck5.framework.security.core.service.SecurityFrameworkServiceImpl;
 ...
 *
 * 注意，不能和 {@link Lucky5WebSecurityConfigurerAdapter} 用一个，原因是会导致初始化报错。
...
public class Lucky5SecurityAutoConfiguration {
