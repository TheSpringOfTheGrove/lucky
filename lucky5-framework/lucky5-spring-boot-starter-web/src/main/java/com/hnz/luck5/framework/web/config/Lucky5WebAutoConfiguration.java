package com.hnz.luck5.framework.web.config;
...
import com.hnz.luck5.framework.web.core.filter.CacheRequestBodyFilter;
import com.hnz.luck5.framework.web.core.filter.DemoFilter;
import com.hnz.luck5.framework.web.core.handler.GlobalExceptionHandler;
import com.hnz.luck5.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class Lucky5WebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "lucky5.demo", havingValue = "true")
