package com.hnz.luck5.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.hnz.luck5.framework.common.util.json.JsonUtils;
import com.hnz.luck5.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${lucky5.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class Lucky5MybatisAutoConfiguration {
