package com.hnz.luck5.framework.mybatis.core.util;
...
import com.hnz.luck5.framework.common.pojo.SortingField;
import com.hnz.luck5.framework.mybatis.core.enums.DbTypeEnum;
...
public class MyBatisUtils {
    ...
    public static <T> Page<T> buildPage(PageParam pageParam, Collection<SortingField> sortingFields) {
        ...
        page.setOptimizeJoinOfCountSql(false); // 关联 issue：https://gitee.com/zhijiantianya/lucky5-cloud/issues/ID2QLL
        // 排序字段
