package com.hnz.luck5.framework.tenant.config;

import com.hnz.luck5.framework.common.biz.system.tenant.TenantCommonApi;
...
import com.hnz.luck5.framework.redis.config.Lucky5CacheProperties;
...
import com.hnz.luck5.framework.tenant.core.aop.TenantIgnoreAspect;
import com.hnz.luck5.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.hnz.luck5.framework.tenant.core.job.TenantJobAspect;
import com.hnz.luck5.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.hnz.luck5.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.hnz.luck5.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.hnz.luck5.framework.tenant.core.redis.TenantRedisCacheManager;
import com.hnz.luck5.framework.tenant.core.security.TenantSecurityWebFilter;
import com.hnz.luck5.framework.tenant.core.service.TenantFrameworkService;
import com.hnz.luck5.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.hnz.luck5.framework.tenant.core.web.TenantContextWebFilter;
import com.hnz.luck5.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "lucky5.tenant", value = "enable", matchIfMissing = true) // 允许使用 lucky5.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class Lucky5TenantAutoConfiguration {
    ...
    @ConditionalOnClass(name = "com.hnz.luck5.framework.mq.redis.core.interceptor.RedisMessageInterceptor")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     Lucky5CacheProperties lucky5CacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(lucky5CacheProperties.getRedisScanBatchSize()));
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = "com.hnz.luck5.framework.quartz.core.handler.JobHandler")
