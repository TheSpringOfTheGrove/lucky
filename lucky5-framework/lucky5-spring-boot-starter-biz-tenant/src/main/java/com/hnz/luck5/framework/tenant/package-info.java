 ...
 *      1）Spring Async：
 *          {@link com.hnz.luck5.framework.quartz.config.Lucky5AsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 Lucky5SecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.hnz.luck5.framework.tenant;
