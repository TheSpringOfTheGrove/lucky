...
import com.hnz.luck5.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "lucky5.tracer", value = "enable", matchIfMissing = true)
public class Lucky5TracerAutoConfiguration {
