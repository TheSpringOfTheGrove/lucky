package com.hnz.luck5.module.member.convert.level;

import com.hnz.luck5.module.member.api.level.dto.MemberLevelRespDTO;
import com.hnz.luck5.module.member.controller.admin.level.vo.level.MemberLevelCreateReqVO;
import com.hnz.luck5.module.member.controller.admin.level.vo.level.MemberLevelRespVO;
import com.hnz.luck5.module.member.controller.admin.level.vo.level.MemberLevelSimpleRespVO;
import com.hnz.luck5.module.member.controller.admin.level.vo.level.MemberLevelUpdateReqVO;
import com.hnz.luck5.module.member.controller.app.level.vo.level.AppMemberLevelRespVO;
