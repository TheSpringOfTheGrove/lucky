package com.hnz.luck5.module.infra.controller.admin.job.vo.log;
...
import com.hnz.luck5.module.infra.enums.DictTypeConstants;
...
public class JobLogRespVO {
    ...
    @Schema(description = "处理器的参数", example = "lucky5")
