package com.hnz.luck5.module.infra.service.logger;
...
import com.hnz.luck5.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.hnz.luck5.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.hnz.luck5.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.hnz.luck5.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.hnz.luck5.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.hnz.luck5.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("lucky5-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("lucky5-test");
