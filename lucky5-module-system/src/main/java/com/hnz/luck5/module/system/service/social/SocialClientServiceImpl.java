package com.hnz.luck5.module.system.service.social;
...
import com.hnz.luck5.framework.common.util.cache.CacheUtils;
import com.hnz.luck5.framework.common.util.http.HttpUtils;
import com.hnz.luck5.framework.common.util.object.BeanUtils;
import com.hnz.luck5.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.hnz.luck5.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import com.hnz.luck5.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.hnz.luck5.module.system.dal.dataobject.social.SocialClientDO;
import com.hnz.luck5.module.system.dal.mysql.social.SocialClientMapper;
import com.hnz.luck5.module.system.dal.redis.RedisKeyConstants;
import com.hnz.luck5.module.system.enums.social.SocialTypeEnum;
import com.hnz.luck5.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.hnz.luck5.framework.common.util.collection.MapUtils.findAndThen;
import static com.hnz.luck5.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.hnz.luck5.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${lucky5.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${lucky5.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/lucky5-cloud/pulls/230
