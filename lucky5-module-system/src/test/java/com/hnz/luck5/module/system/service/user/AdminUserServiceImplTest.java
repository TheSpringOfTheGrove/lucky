package com.hnz.luck5.module.system.service.user;
...
import com.hnz.luck5.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.hnz.luck5.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.hnz.luck5.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.hnz.luck5.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.hnz.luck5.module.system.controller.admin.user.vo.user.UserSaveReqVO;
...
import com.hnz.luck5.module.system.dal.dataobject.dept.UserPostDO;
import com.hnz.luck5.module.system.dal.dataobject.tenant.TenantDO;
import com.hnz.luck5.module.system.dal.dataobject.user.AdminUserDO;
import com.hnz.luck5.module.system.dal.mysql.dept.UserPostMapper;
import com.hnz.luck5.module.system.dal.mysql.user.AdminUserMapper;
import com.hnz.luck5.module.system.enums.common.SexEnum;
import com.hnz.luck5.module.system.mq.producer.user.AdminUserProducer;
...
import static com.hnz.luck5.framework.common.util.collection.SetUtils.asSet;
...
import static com.hnz.luck5.module.system.enums.ErrorCodeConstants.*;
import static com.hnz.luck5.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        assertEquals("lucky5yuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("lucky5yuanma"))).thenReturn("java");
