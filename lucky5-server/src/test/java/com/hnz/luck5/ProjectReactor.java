...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.hnz.boot";
    private static final String ARTIFACT_ID = "lucky5";
    private static final String PACKAGE_NAME = "com.hnz.luck5";
    private static final String TITLE = "Lucky Lottery";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.hnz.boot";
        String artifactIdNew = "lucky5";
        String packageNameNew = "com.hnz.luck5";
        String titleNew = "Lucky Lottery";
