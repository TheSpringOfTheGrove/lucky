        ...
        <template #header>
          <div class="h-3 flex justify-between">
            ...
            <el-link
              type="primary"
              :underline="false"
              href="https://github.com/lucky5code"
              target="_blank"
            >
              {{ t('action.more') }}
            </el-link>
...
const getProject = async () => {
  const data = [
    ...
    {
      name: 'lucky5-ui-admin-vue3',
      icon: 'ep:element-plus',
      message: 'github.com/lucky5code/lucky5-ui-admin-vue3',
      personal: 'Vue3 + element-plus 管理后台',
      time: new Date('2025-02-03'),
      color: '#409EFF'
    },
    {
      name: 'lucky5-ui-mall-uniapp',
      icon: 'icon-park-outline:mall-bag',
      message: 'github.com/lucky5code/lucky5-ui-mall-uniapp',
    ...
    },
    {
      ...
      message: 'github.com/YunaiV/lucky5-cloud',
      personal: 'Spring Cloud 微服务架构',
      time: new Date('2025-04-05'),
      color: '#1890ff'
    },
    {
      name: 'lucky5-ui-admin-vben',
      icon: 'devicon:antdesign',
      message: 'github.com/lucky5code/lucky5-ui-admin-vben',
      personal: 'Vue3 + vben5(antd) 管理后台',
      time: new Date('2025-05-06'),
      color: '#e18525'
    },
    {
      name: 'lucky5-ui-admin-uniapp',
      icon: 'ant-design:mobile',
      message: 'github.com/lucky5code/lucky5-ui-admin-uniapp',
